...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    collaborate: Schema.Attribute.Component<
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    getinTouch: Schema.Attribute.Component<'common.button', false>;
    heroSection: Schema.Attribute.Component<
      'common.title-with-description',
      true
    >;
    impactSection: Schema.Attribute.Component<'aboutus.impact', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    testimonials: Schema.Attribute.Component<'aboutus.testimonials', true>;
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blogContent: Schema.Attribute.Component<
      'common.title-with-description',
      true
    >;
    blogDate: Schema.Attribute.Date;
    blogger: Schema.Attribute.String;
    bloggerPhoto: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    blogId: Schema.Attribute.UID<'title'>;
...
export interface ApiCareerCareer extends Struct.SingleTypeSchema {
  ...
  attributes: {
    careers: Schema.Attribute.DynamicZone<['common.title-with-description']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    caseStudyId: Schema.Attribute.UID<'title'>;
    caseStudyPhoto: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    newsletter: Schema.Attribute.Component<'footer.news-letter', false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    demobtn: Schema.Attribute.Component<'common.button', false>;
    headerlinks: Schema.Attribute.Component<'footer.links', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::header.header'
...
export interface ApiMainCaseStudyMainCaseStudy extends Struct.SingleTypeSchema {
  collectionName: 'main_case_studies';
  info: {
    description: '';
    displayName: 'MainCaseStudy';
    pluralName: 'main-case-studies';
    singularName: 'main-case-study';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::main-case-study.main-case-study'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiSolutionSolution extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    services: Schema.Attribute.Component<'common.title-with-description', true>;
    servicesContent: Schema.Attribute.Component<
      'common.title-with-description',
      false
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTeamTeam extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    crew: Schema.Attribute.Component<'common.title-with-description', false>;
    founders: Schema.Attribute.Component<'team.founders', true>;
    heroSection: Schema.Attribute.Component<
      'common.title-with-description',
      false
    >;
    joincrew: Schema.Attribute.Component<
      'common.title-with-description',
      false
    >;
    joinusBtn: Schema.Attribute.Component<'common.button', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
